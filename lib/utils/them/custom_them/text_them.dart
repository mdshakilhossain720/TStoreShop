...
class TTextThem{
  ...
  static TextTheme lightTextThem=TextTheme(
    ...
    titleSmall: TextStyle().copyWith(fontSize: 14,fontWeight: FontWeight.w400,color: Colors.black),



    bodyLarge: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.w600,color: Colors.black),
    bodyMedium: TextStyle().copyWith(fontSize: 14,fontWeight: FontWeight.w500,color: Colors.black),
    bodySmall: TextStyle().copyWith(fontSize: 14,fontWeight: FontWeight.w400,color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTextThem=TextTheme(
    ...
    titleSmall: TextStyle().copyWith(fontSize: 14,fontWeight: FontWeight.w400,color: Colors.white),



    bodyLarge: TextStyle().copyWith(fontSize: 14.0,fontWeight: FontWeight.w600,color: Colors.white),
    bodyMedium: TextStyle().copyWith(fontSize: 14,fontWeight: FontWeight.w500,color: Colors.white),
    bodySmall: TextStyle().copyWith(fontSize: 14,fontWeight: FontWeight.w400,color: Colors.white.withOpacity(0.5)),
